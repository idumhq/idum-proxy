...
from idum_proxy.networking.connection_pooling.tracing.default_trace_handler import TraceHandlers, DefaultTraceHandlers
        ...
        try:
            ...
            if is_streaming:
                ...
                try:
                    ...
                    timeout = ClientTimeout(total=60, connect=10, sock_read=15, sock_connect=10)
